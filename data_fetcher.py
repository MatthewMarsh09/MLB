...
def load_comprehensive_player_data():
    """Load comprehensive historical MLB player data with all teams"""
    players = [
        # Top fWAR players with all teams
        {"name": "Babe Ruth", "fwar": 182.5, "teams": ["New York Yankees", "Boston Red Sox"], "positions": ["OF", "P"], "years_active": ["1914", "1935"], "minor_league": False, "international_signing": False},
        ...
        {"name": "Mariano Rivera", "fwar": 56.3, "teams": ["New York Yankees"], "positions": ["P"], "years_active": ["1995", "2013"], "minor_league": False, "international_signing": True, "signing_country": "Panama"},
        ...
        {"name": "Aroldis Chapman", "fwar": 20.1, "teams": ["Cincinnati Reds", "New York Yankees", "Chicago Cubs", "Kansas City Royals", "Texas Rangers", "Pittsburgh Pirates"], "positions": ["P"], "years_active": ["2010", "2024"], "minor_league": False, "international_signing": True, "signing_country": "Cuba"},
        ...
        {"name": "Daisuke Matsuzaka", "fwar": 9.8, "teams": ["Boston Red Sox", "New York Mets", "Cleveland Guardians"], "positions": ["P"], "years_active": ["2007", "2014"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Kazuhiro Sasaki", "fwar": 7.1, "teams": ["Seattle Mariners"], "positions": ["P"], "years_active": ["2000", "2003"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Hideki Irabu", "fwar": 1.2, "teams": ["New York Yankees", "Montreal Expos", "Texas Rangers"], "positions": ["P"], "years_active": ["1997", "2002"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Shingo Takatsu", "fwar": 0.8, "teams": ["Chicago White Sox", "New York Mets"], "positions": ["P"], "years_active": ["2004", "2005"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Tadahito Iguchi", "fwar": 8.1, "teams": ["Chicago White Sox", "Philadelphia Phillies", "San Diego Padres"], "positions": ["2B"], "years_active": ["2005", "2008"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Kosuke Fukudome", "fwar": 6.2, "teams": ["Chicago Cubs", "Cleveland Guardians", "Chicago White Sox"], "positions": ["RF", "OF"], "years_active": ["2008", "2012"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Norichika Aoki", "fwar": 9.4, "teams": ["Milwaukee Brewers", "Kansas City Royals", "San Francisco Giants", "Seattle Mariners", "Houston Astros", "New York Mets", "Toronto Blue Jays"], "positions": ["RF", "OF"], "years_active": ["2012", "2017"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Tsuyoshi Shinjo", "fwar": 1.5, "teams": ["New York Mets", "San Francisco Giants"], "positions": ["CF", "OF"], "years_active": ["2001", "2003"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "So Taguchi", "fwar": 2.8, "teams": ["St. Louis Cardinals", "Philadelphia Phillies", "Chicago Cubs"], "positions": ["OF"], "years_active": ["2002", "2009"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Akinori Iwamura", "fwar": 7.9, "teams": ["Tampa Bay Rays", "Pittsburgh Pirates", "Oakland Athletics"], "positions": ["2B", "3B"], "years_active": ["2007", "2010"], "minor_league": False, "international_signing": True, "signing_country": "Japan"},
        {"name": "Munetaka Murakami", "fwar": 0.0, "teams": ["Yakult Swallows"], "positions": ["3B"], "years_active": ["2019", "2024"], "minor_league": True, "international_signing": True, "signing_country": "Japan"},
        {"name": "Roki Sasaki", "fwar": 0.0, "teams": ["Chiba Lotte Marines"], "positions": ["P"], "years_active": ["2021", "2024"], "minor_league": True, "international_signing": True, "signing_country": "Japan"},
    ]
    return players
...
def main():
    ...
    print("Loading comprehensive MLB player data...")
    
    players = load_comprehensive_player_data()
    ...
    print(f"Data loading complete! {len(processed)} players loaded.")
